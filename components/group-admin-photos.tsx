...
export function GroupAdminPhotos({ groupId }: { groupId: string }) {
  ...
  React.useEffect(() => {
    load();
    // eslint-disable-next-line react-hooks/exhaustive-deps -- load only when groupId changes
  }, [groupId]);
  ...
  async function handleUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    const { error: insertErr } = await supabase.from("group_photos").insert({
      group_id: groupId,
